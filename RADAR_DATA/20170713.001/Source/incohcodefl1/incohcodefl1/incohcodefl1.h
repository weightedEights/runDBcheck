//Mode definitions
#define MODENAME "IncohCodeFl1"
#define MODEVERSION "3.2"
#define MODEMODIFIED 20110417
#define MODETYPE 11
...
typedef struct
{
	...
	int calcstep;  //sample skipping in calculations
	int fraction;  //oversampling factor
	int codelength; //number of codes in code
	int baud; // number of bauds in code
	int nlags; // number of lags in calc acf
	int elags; // number of lags in output acf
